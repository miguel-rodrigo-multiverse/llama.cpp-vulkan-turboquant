void load_a_to_shmem(const uint pos_a, const uint row, const uint col, const uint idx_m, const uint block, const uint end_k) {
            ...
            buf_a[buf_idx    ] = FLOAT_TYPEV2(kvalues_mxfp4_f[vui  & 0xF] * d,
                                              kvalues_mxfp4_f[vui2 & 0xF] * d);
            buf_a[buf_idx + 8] = FLOAT_TYPEV2(kvalues_mxfp4_f[vui  >>  4] * d,
                                              kvalues_mxfp4_f[vui2 >>  4] * d);
            ...
            buf_a[buf_idx    ] = FLOAT_TYPEV2(kvalues_mxfp4_f[vui  & 0xF] * d,
                                              kvalues_mxfp4_f[vui2 & 0xF] * d);
            buf_a[buf_idx + 4] = FLOAT_TYPEV2(kvalues_mxfp4_f[vui  >>  4] * d,
                                              kvalues_mxfp4_f[vui2 >>  4] * d);
#endif
}
